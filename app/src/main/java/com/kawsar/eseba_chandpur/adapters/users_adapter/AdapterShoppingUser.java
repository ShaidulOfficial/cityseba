...
public class AdapterShoppingUser extends RecyclerView.Adapter<AdapterShoppingUser.ViewHolderNewsUser> {
    Context context;
    List<CommonModel> newsUserModelList;
    public AdapterShoppingUser(Context context, List<CommonModel> modelList) {
        this.context = context;
        this.newsUserModelList = modelList;
    }
    public void setFilterList_shoppingUser(List<CommonModel> filterList) {
